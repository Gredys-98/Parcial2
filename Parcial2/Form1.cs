...
namespace Parcial2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.IngresarDoc.Text = archivo.ruta; 
            string[] filas = archivo.obtenerFilas();

           
            foreach (string linea in filas)
            {
                this.IngresarDoc.Items.Add(linea);
            }
        ...
        {
            this.ListaordenAlumnos.Items.Clear();
            string[] datos = arreglo.OrdenarString(this.matriz, 1);
            for (int i = 0; i < datos.Length; i++)
            {
                this.ListaordenAlumnos.Items.Add(datos[i]);
            }
        }
        ...
        {
            this.PromedioporParcial.Items.Clear();
            int datos = promedios.promedios_por_parcial(this.matriz, 2);
            this.PromedioporParcial.Items.Add("Promedio por Parcial Uno: "+datos);
        }
        ...
        private void btnPromedioP2_Click(object sender, EventArgs e)
        {
            ...
            this.PromedioporParcial.Items.Add("Promedio por Parcial Dos: " + datos);
        }
        ...
        {
            this.PromedioporParcial.Items.Clear();
            string seccion = this.SEleccion.Text;
            int datos = promedios.promedios_por_seccion(this.matriz, 6,seccion);
            this.PromedioporParcial.Items.Add("Promedio General Por Seccion "+seccion+" :" + datos);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            this.PromediGeneralPorSeccion.Items.Clear();
            string seccion = this.SEleccion.Text;
            int datos = promedios.promedios_por_seccion(this.matriz, 2, seccion);
            this.PromediGeneralPorSeccion.Items.Add("Promedio General Por Parcial Uno en la Sección " + seccion + " :" + datos);
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                this.PromediGeneralPorSeccion.Items.Add(datos[i,0]+"- Sumatoria: " +datos[i, 1]);
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < datos.GetLength(0); i++)
            {
                this.PromediGeneralPorSeccion.Items.Add(datos[i, 0] + "; "+ datos[i, 1] + "; "+ datos[i, 2] + "; "+ datos[i, 3] + "; "+ datos[i, 4] + "; "+datos[i, 5] + "; "+datos[i, 6] + "; ");
            }
        }
